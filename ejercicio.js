...
function canBuyProduct() {
    ...
    const descuentoproducto=0.25;
    const presupuesto=1150;
    const preciofinal= precioproducto - (precioproducto*descuentoproducto);
    console.log (presupuesto>=preciofinal?"si podes comprar":"No podes comprar");
